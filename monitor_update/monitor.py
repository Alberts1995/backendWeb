...
class Day_merj():
    def get(self):
        while True:
            ...
            #Update
            bd.update_month(month[0]['Month_Plan_FB'], month[0]["Month_Total_Merjinalnost_FB"],  month[0]["Month_Total_Gross_FB"], 
            ...
            bd.update_day(day[0]['Day_Plan_FB'], day[0]["Day_Total_Merjinalnost_FB"],  day[0]["Day_Total_Gross_FB"], 
            ...
            for key, value in day.items():
                if key == "FB":
                    for i  in value:
                        bd.update_table(i["reckl"], i["gross"], i["morja"], "Day", key, days)
                elif key == "scheme":
                    for i  in value:
                        bd.update_table(i["reckl"], i["gross"], i["morja"], "Day", key, days)
            ...
            for key, value in month.items():
                if key == "FB":
                    for i  in value:
                        bd.update_table(i["reckl"], i["gross"], i["morja"], "Month", key, days)
                elif key == "scheme":
                    for i  in value:
                        bd.update_table(i["reckl"], i["gross"], i["morja"], "Month", key, days)

            # #insert
            # bd.plan_month(month[0]['Month_Plan_FB'], month[0]["Month_Total_Merjinalnost_FB"],  month[0]["Month_Total_Gross_FB"], 
            # month[1]['Month_Plan_sxema'], month[1]["Month_Total_Merjinalnost_sxema"],  month[1]["Month_Total_Gross_sxema"],
            # month[2]['month_Plan_prochee'], month[2]["Month_Total_Merjinalnost_prochee"],  month[2]["Month_Total_Gross_prochee"])

            # bd.plan_day(day[0]['Day_Plan_FB'], day[0]["Day_Total_Merjinalnost_FB"],  day[0]["Day_Total_Gross_FB"], 
            # day[1]['Day_Plan_sxema'], day[1]["Day_Total_Merjinalnost_Sxema"],  day[1]["Day_Total_Gross_Sxema"],
            # day[2]['Day_Plan_prochee'], day[2]["Day_Total_Merjinalnost_prochee"],  day[2]["Day_Total_Gross_prochee"])
            ...
            #                 bd.insert_day(i["new"] , i["reckl"], p, i["plan_day"], i["gross"], i["morja"], key, days)
            #                 continue
            #             bd.insert_day(i["new"] , i["reckl"], i["offer"], i["plan_day"], i["gross"], i["morja"], key, days)
            ...
            #             bd.insert_day(i["new"] , i["reckl"], i["offer"], i["plan_day"], i["gross"], i["morja"], key, days)
            #     elif key == "other":
            #         bd.insert_day(0, 0, 0, 0, 0, 0, key, days)
            ...
            #             if type(i["offer"]) is list:
            #                 p = ", ".join(str(x) for x in i["offer"])
            #                 bd.insert_month(i["new"] , i["reckl"], p, i["plan_month"], i["gross"], i["morja"], key, days)
            #                 continue
            #             bd.insert_month(i["new"] , i["reckl"], i["offer"], i["plan_month"], i["gross"], i["morja"], key, days)
            ...
            #     elif key == "other":
            #         bd.insert_month(0, 0, 0, 0, 0, 0, key, days)
